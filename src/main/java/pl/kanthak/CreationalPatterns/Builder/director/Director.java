package pl.kanthak.CreationalPatterns.Builder.director;


import pl.kanthak.CreationalPatterns.Builder.builders.Builder;
...
public class Director {
    ...
    public void constructCityCar(Builder builder) {
        ...
        builder.setTripComputer(new TripComputer());
        builder.setGPSNavigator(new GPSNavigator("Route to Warsaw"));
    }
    ...
    public void constructSUV(Builder builder) {
        ...
        builder.setTripComputer(new TripComputer());
        builder.setGPSNavigator(new GPSNavigator("Route to Poznan"));
    }
}
